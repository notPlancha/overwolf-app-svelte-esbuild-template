(() => {
  ...
  function create_fragment3(ctx) {
    ...
    return {
      c() {
        ...
        main = element("main");
        h1 = element("h1");
        h1.textContent = "Hello from Desktop!";
        t2 = space();
  ...
  var Desktop = class extends SvelteComponent {
    constructor(options) {
      super();
  ...
  // temp/index.Desktop.svelte.ts
  var app = new Desktop_default({
    target: document.getElementById("app")
  });
  var index_Desktop_svelte_default = app;
})();
